...
@rem ##########################################################################
@rem
@rem  GuaranteedProcessor startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and GUARANTEED_PROCESSOR_OPTS to pass JVM options to this script.
...
@rem Execute GuaranteedProcessor
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %GUARANTEED_PROCESSOR_OPTS%  -classpath "%CLASSPATH%" com.solace.samples.jcsmp.patterns.GuaranteedProcessor %*
...
:fail
rem Set variable GUARANTEED_PROCESSOR_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
set EXIT_CODE=%ERRORLEVEL%
if %EXIT_CODE% equ 0 set EXIT_CODE=1
if not ""=="%GUARANTEED_PROCESSOR_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
