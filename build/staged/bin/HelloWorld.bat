...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %HELLO_WORLD_OPTS%  -classpath "%CLASSPATH%" com.solace.samples.jcsmp.HelloWorld %*
...
if not ""=="%HELLO_WORLD_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
