...
@rem ##########################################################################
@rem
@rem  DirectProcessor startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and DIRECT_PROCESSOR_OPTS to pass JVM options to this script.
...
@rem Execute DirectProcessor
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %DIRECT_PROCESSOR_OPTS%  -classpath "%CLASSPATH%" com.solace.samples.jcsmp.patterns.DirectProcessor %*
...
:fail
rem Set variable DIRECT_PROCESSOR_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
set EXIT_CODE=%ERRORLEVEL%
if %EXIT_CODE% equ 0 set EXIT_CODE=1
if not ""=="%DIRECT_PROCESSOR_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
