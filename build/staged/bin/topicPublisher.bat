...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TOPIC_PUBLISHER_OPTS%  -classpath "%CLASSPATH%" com.solace.samples.jcsmp.features.TopicPublisher %*
...
if not ""=="%TOPIC_PUBLISHER_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
